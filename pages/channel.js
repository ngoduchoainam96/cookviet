...
export default class extends React.Component {
  ...
  state = {
    ...
    userID: undefined,
    peers: [],
    title: "Chờ người khác kết nối...",
    history: [
      { msg: "Chờ người khác kết nối...", type: "system", time: Date.now() }
    ],
    message: ""
  };
        ...
        <SingleBox active={this.state.visible === 1} row wide>
          <Left>
            <div>
              ...
              />
              <p>ID của bạn: {this.state.userID}</p>
              <p>Số người kết nối: {this.state.peers.length}</p>
              <br />
              <p>Chia sẻ địa chỉ phòng:</p>
